...
export function App() {
  ...
  const salaryFrequencyOptions = [
    {
      value: 'Annual',
      label: 'Annual',
      count: salaryFrequencyCounts['Annual'] || 0,
    },
    {
      value: 'Hourly',
      label: 'Hourly',
      count: salaryFrequencyCounts['Hourly'] || 0,
    },
    {
      value: 'Daily',
      label: 'Daily',
      count: salaryFrequencyCounts['Daily'] || 0,
    },
  ]
  // ==============================
  ...
  const postingTypeOptions = [
    {
      value: 'Internal',
      label: 'Internal',
      count: postingTypeCounts['Internal'] || 0,
    },
    {
      value: 'External',
      label: 'External',
      count: postingTypeCounts['External'] || 0,
    },
  ]
  // ==============================
  ...
  return (
    <>
      ...
      <div role="doc-subtitle" className="pl-6 pb-6 font-semibold">
      ...
      <main
        className="grid gap-6 p-6 sm:grid-cols-2 md:grid-cols-3
